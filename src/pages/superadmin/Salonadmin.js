  ...
  return (
    <AdminLayout>
      <div className="flex justify-center items-center bg-gray-100 py-10 px-4">
        <div className="bg-white p-8 rounded-2xl shadow-lg w-full sm:w-11/12 ">
          <h1
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 bg-gray-50 p-4 rounded-lg shadow-md">
              {[
                ...
                <label
                  key={service}
                  className="flex items-center bg-white p-3 rounded-lg shadow-sm border border-gray-300 cursor-pointer hover:bg-gray-100"
                >
                  <input
                    type="checkbox"
                    value={service}
